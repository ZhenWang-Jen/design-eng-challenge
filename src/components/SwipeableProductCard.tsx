      ...
      <AnimatePresence>
        {!swipe && (
          <motion.div
            ...
            animate={{ rotateY: flipped ? 180 : 0, x: 0, opacity: 1 }}
            initial={{ x: 0, opacity: 1 }}
            exit={swipe === 'right' ? { x: 500, opacity: 0 } : swipe === 'left' ? { x: -500, opacity: 0 } : { opacity: 0 }}
          ...
          >
            ...
            >
              ...
              <div className="font-bold text-lg mb-1 text-center text-gray-800">{product.title}</div>
